      ...
      <main className="container py-12">
        <header className="grid items-center gap-6 md:grid-cols-2">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-prose">From discovery to optimization, we deliver conversion-focused experiences with clean code, scalable design systems, and performance that ranks.</p>
          </div>
        ...
        <section className="mt-16">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3 lg:grid-cols-3">
            <Card className="overflow-hidden hover-scale animate-fade-in">
              <img src="/images/whatwedo-1.jpg" alt="Website design examples for modern brands" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden hover-scale animate-fade-in">
              <img src="/images/whatwedo-2.jpg" alt="UI and UX screens showcasing app interfaces" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden hover-scale animate-fade-in">
              <img src="/images/whatwedo-3.jpg" alt="Brand identity mockups for a B2B company" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden hover-scale animate-fade-in">
              <img src="/images/whatwedo-4.jpg" alt="Analytics chart illustrating SEO performance" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden hover-scale animate-fade-in">
              <img src="/images/whatwedo-5.jpg" alt="E-commerce storefront with product grid and checkout" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden hover-scale animate-fade-in">
              <img src="/images/whatwedo-6.jpg" alt="Design system components and guidelines" className="h-32 w-full object-cover" loading="lazy" />
        ...
        <section className="mt-16">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            <Card className="overflow-hidden">
              <img src="/images/process-1.jpg" alt="Discover phase research and audit" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden">
              <img src="/images/process-2.jpg" alt="Define phase roadmap and requirements" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden">
              <img src="/images/process-3.jpg" alt="Design phase UI screens and components" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden">
              <img src="/images/process-4.jpg" alt="Develop phase code and performance tools" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden">
              <img src="/images/process-5.jpg" alt="Launch phase with QA and checklists" className="h-32 w-full object-cover" loading="lazy" />
            ...
            <Card className="overflow-hidden">
              <img src="/images/process-6.jpg" alt="Optimize phase analytics and experiments" className="h-32 w-full object-cover" loading="lazy" />
        ...
        <section className="mt-16">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card className="hover-scale">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <img src="/images/client-a.jpg" alt="Portrait of Jamie Lee, Marketing Director" className="h-10 w-10 rounded-full object-cover" loading="lazy" />
                  <div>
            ...
            <Card className="hover-scale">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <img src="/images/client-b.jpg" alt="Portrait of Morgan Cruz, Founder" className="h-10 w-10 rounded-full object-cover" loading="lazy" />
                  <div>
            ...
            <Card className="hover-scale">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <img src="/images/client-c.jpg" alt="Portrait of Priya Shah, Product Lead" className="h-10 w-10 rounded-full object-cover" loading="lazy" />
                  <div>
            ...
            <Card className="hover-scale">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <img src="/images/client-d.jpg" alt="Portrait of Daniel Kim, COO" className="h-10 w-10 rounded-full object-cover" loading="lazy" />
                  <div>
            ...
            <Card className="hover-scale">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <img src="/images/client-e.jpg" alt="Portrait of Sofia Alvarez, VP Growth" className="h-10 w-10 rounded-full object-cover" loading="lazy" />
                  <div>
            ...
            <Card className="hover-scale">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <img src="/images/client-f.jpg" alt="Portrait of Ahmed Saleh, Head of Digital" className="h-10 w-10 rounded-full object-cover" loading="lazy" />
                  <div>
